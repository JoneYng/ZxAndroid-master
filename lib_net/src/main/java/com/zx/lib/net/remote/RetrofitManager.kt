...
import com.zx.lib.net.remote.interceptor.RequestInterceptor
import com.zx.lib.net.remote.interceptor.ResponseInterceptor
import com.zx.lib.net.remote.moshiFactories.MyKotlinJsonAdapterFactory
...
class RetrofitManager {
    ...
    init {
        ...
        if (NetConfig.isEnableHttps()) {
            ...
            val sslParams = com.zx.lib.net.utils.SSLContextUtil.getSslSocketFactory()
            okHttpBuilder.sslSocketFactory(sslParams.sSLSocketFactory, sslParams.trustManager)
            okHttpBuilder.hostnameVerifier(com.zx.lib.net.utils.SSLContextUtil.UnSafeHostnameVerifier)
        }
    ...
    private fun getMoshi(): Moshi {
        return Moshi.Builder()
            ...
            .add(com.zx.lib.net.remote.moshiFactories.MyStandardJsonAdapters.FACTORY)
            .build()
    }
}
